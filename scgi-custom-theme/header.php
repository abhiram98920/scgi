...
<div class="top-bar">
    <div class="container wrap">
        ...
        <div class="tb-right">
            <span><i class="fas fa-map-marker-alt"></i><?php echo esc_html(get_theme_mod('scgi_address', 'Kolar, Karnataka – 563102')); ?></span>
            <span class="tb-divider">|</span>
            <a href="#"><i class="fas fa-award"></i>RGUHS Affiliated</a>
            <span class="tb-divider">|</span>
            <a href="#"><i class="fas fa-star"></i>Govt. Recognised</a>
            <a href="#enquire" class="tb-gold-btn">Enquire Now</a>
        </div>
    </div>
</div>
